...
The data storage and the sharing strategy within the project (between company and university) was determined as follows: The overall strategy used in this case was to decide that this was mostly a company activity, supervised and handled by the company, for which a subset was used for the MSc studies. In this instance, it seemed easier to argue that the collected data was collected by the hosting company, as part of its "regular" activity. Therefore the data should be stored in the "regular" coporate way, but some of it is transfered to the university for research purposes.
...
Despite participating in meetings organized by the company, the student was requested by the university's Ethics committee to create consent forms, informing participants what would happen to the data they provide (public archival), and who would have access to it (both the university _and_ the company supervisor)
...
- The student will share anonymized summaries of the meeting notes with their university supervisors, hence limiting personal data transfer and avoiding the need for GDPR-related data transfer agreements.
